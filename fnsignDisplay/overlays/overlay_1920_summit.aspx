...
<head id="Head1" runat="server">
		...
		<style type="text/css">
			...
			.session-time { font-family: "Gotham Narrow A", "Gotham Narrow B";font-style: normal;font-weight: 800; margin-top: 15px;margin-bottom: 15px; font-size: 36px; color: #ffffff;width: 100%; }
